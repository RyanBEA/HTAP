...
// Create Table 4 with correct 9-column structure - ALL 40 ROWS
const table4Rows = [
  // Row 0: Header
  new TableRow({
    children: [
...
const doc = new Document({
  sections: [{
    children: [
      new Paragraph({
        children: [new TextRun({ text: "Table 4 Complete Test - D.1 Performance Compliance (40 rows)", bold: true, size: 24 })]
      }),
      table4
    ]
  }]
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("test_table4_complete.docx", buffer);
  console.log("Complete Table 4 (40 rows) generated: test_table4_complete.docx");
});
