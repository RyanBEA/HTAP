// Correct Table 4 (D.1 Performance Compliance) structure
// 9 columns total, each column width = 1040 DXA (total 9360 DXA)
...
const table4Rows = [
  ...
  // Row 3: Cathedral ceilings (vertically merged cell continues)
  new TableRow({
    children: [
      // Cell 0 is merged from row 2, so we skip it
  ...
  new TableRow({
    children: [
      ...
      createCell("", 2080, { shading: "FFFFFF", colSpan: 2 })  // Note: no shading
    ]
  }),
...
// Usage:
// Replace the existing Table 4 with:
/*
new Table({
